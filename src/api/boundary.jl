...
# representation (see `pagos-roadmap/chmy.md`, Phase 2). Two functions carry data across that
...
filled by boundary conditions, see `pagos-roadmap/chmy.md`, Phase 4). Element types are
