...
# pagos-roadmap) — never against the 2D solve, which discretizes different points entirely.
...
@testset "Blatter-Pattyn pseudo-transient momentum solver (C-grid staggered)" begin
    ...
    @testset "Gershgorin bound reduces to the 2D bound at nz == 1 magnitude order" begin
        ...
        # pagos-roadmap's §2.1 sanity check calls for cannot be exercised end-to-end through
